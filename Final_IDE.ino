...
// #define limitSwitch2 10  //B-as
// #define limitSwitch3 9   //C-as
// #define limitSwitch4 11  //Z-as

Bounce2::Button A = Bounce2::Button();
// Bounce2::Button B = Bounce2::Button();
// Bounce2::Button C = Bounce2::Button();
// Bounce2::Button Z = Bounce2::Button();
...
void setup() {
  ...
  //switch setup
    ...
    // B.attach(limitSwitch2, INPUT_PULLUP);  
    // C.attach(limitSwitch3, INPUT_PULLUP);  
    // Z.attach(limitSwitch4, INPUT_PULLUP);  
    ...
    // C.setPressedState(HIGH);
    // Z.setPressedState(LOW);
...
void loop() {
  ...
  //process movement
    ...
    //Update robotposition
      ...
      //   A_Current_Position = stepper_A.getCurrentPositionInSteps()/A_steps_degree;
      //   B_Current_Position = stepper_B.getCurrentPositionInSteps()/B_steps_degree;
      //   C_Current_Position = stepper_C.getCurrentPositionInSteps()/C_steps_degree;
      //   Z_Current_Position = stepper_Z.getCurrentPositionInSteps()/Z_steps_mm;
      
    //Send robotstatus every 20th loop
      // i++;
      // if (i==20){
      //   Send_status(2);
      //   i=0;
